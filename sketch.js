...
function setup() {
  ...
  box1 = new BlueBox(500,440,20,30);
  box2 = new YellowBox(520,440,20,30);
  box3 = new GreenBox(540,440,20,30);
  box4 = new RedBox(560,440,20,30);
  box5 = new GreenBox(580,440,20,30);
  box6 = new YellowBox(600,440,20,30);
  box7 = new RedBox(510,400,20,30);
  box8 = new YellowBox(530,400,20,30);
  box9 = new BlueBox(550,400,20,30);
  box10 = new GreenBox(570,400,20,30);
  box11 = new RedBox(590,400,20,30);
  box12 = new YellowBox(520,370,20,30);
  box13 = new BlueBox(540,370,20,30);
  box14 = new RedBox(560,370,20,30);
  box15 = new GreenBox(580,370,20,30);
  box16 = new YellowBox(530,340,20,30);
  box17 = new RedBox(550,340,20,30);
  box18 = new GreenBox(570,340,20,30);
  box19 = new BlueBox(540,310,20,30);
  box20 = new RedBox(560,310,20,30);
  box21 = new GreenBox(550,280,20,30);
...
function draw() {
  ...
  textSize(23);
  fill("Black");
  text("Drag The Ball And Release It,", 20, 50);
  
  textSize(23);
  fill("Black");
  text("To Launch It Towards The Block", 20, 90);
